...
description: "sca(spring-cloud-alibaba) spring boot expected single matching bean but found 2"
---

## 用户问题 ： 
 spring boot expected single matching bean but found 2 sca(spring-cloud-alibaba) 
