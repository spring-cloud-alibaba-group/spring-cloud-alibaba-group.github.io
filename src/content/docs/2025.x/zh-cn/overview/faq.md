...
<a href="#1" target="_self">Spring Cloud Alibaba 维护了几个分支，对应的区别是什么？</a>
<br/>

<a href="#2" target="_self">关于组件版本选择，需要去哪参考？</a>
<br/>

<a href="#3" target="_self">社区有版本建设路线规划吗？</a>
<br/>

<a href="#4" target="_self">社区有周会讨论吗，怎么参与进来？</a>
<br/>

<a href="#5" target="_self">Spring Cloud Alibaba 和 Spring Cloud、Spring Cloud Netflix 的区别在哪？</a>
<br/>

<a href="#6" target="_self">有最佳实践示例吗？</a>
<br/>

<a href="#7" target="_self">Spring Cloud Alibaba 可以集成新开源的网关 Higress 吗？</a>
<br/>

<a href="#8" target="_self">如何成为社区 Committer？</a>
<br/>

<a href="#9" target="_self">社区有提供相关的学习资料，或者是技术博客吗？</a>
<br/>

---

<h3 id='1'>Q：Spring Cloud Alibaba 维护了几个分支，对应的区别是什么？</h3>

**A：**

Spring Cloud Alibaba 目前有以下分支在积极维护：`2.2.x`，`2021.x`，`2022.x`，`2023.x`，`2025.0.x`，`2025.1.x`。
...
- [2023.x](https://github.com/alibaba/spring-cloud-alibaba/tree/2023.x)：集成了 Spring Boot 3.2.x 和 Spring Cloud 2023.x。
...
<h3 id='5'>Q：Spring Cloud Alibaba 和 Spring Cloud、Spring Cloud Netflix 的区别在哪？</h3>
...
<h3 id='7'>Q：Spring Cloud Alibaba 可以集成新开源的网关 Higress 吗？</h3>
...
<h3 id='9'>Q：社区有提供相关的学习资料，或者是技术博客吗？</h3>
