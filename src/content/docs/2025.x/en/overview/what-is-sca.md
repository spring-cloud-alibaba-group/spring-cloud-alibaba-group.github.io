...
In addition, Ali Cloud also provides [Spring Cloud Alibaba enterprise version micro-service solutions](https://www.aliyun.com/product/aliware/mse?spm=sca-website.topbar.0.0.0) micro-service solutions, including non-intrusive service governance (full link gray scale, lossless up and down line, rate limiting protection, etc.), enterprise Nacos registration and configuration center, enterprise cloud native API gateway, enterprise AI gateway and many other products.
