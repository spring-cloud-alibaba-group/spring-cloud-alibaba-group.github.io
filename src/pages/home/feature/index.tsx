  ...
  list: [
    {
      ...
      content: [
        translate({
          ...
          message:
            'Spring Cloud Alibaba作为一站式的微服务构建方案，用户只需要添加一些注解和少量配置，就可以通过阿里中间件来迅速搭建分布式应用系统。',
        }),
      ],
    },
    {
      ...
      content: [
        translate({
          ...
          message: '核心组件都经过经历过阿里巴巴多年双十一洪峰考验，成熟稳定。',
        }),
      ],
    },
    {
      ...
      content: translate({
        ...
        message:
          'Spring Cloud Alibaba基于Spring Cloud微服务解决方案规范，可便捷地对其中的组件进行扩展和替换。',
      }),
    },
    {
      icon: 'feature-4',
