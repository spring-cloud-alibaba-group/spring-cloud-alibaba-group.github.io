...
const data = {
  desc: (
    <span>
      ...
      <a rel="noopener noreferrer" target="_blank" href="https://github.com/alibaba/spring-cloud-alibaba/issues/301">
  ...
  title: translate({ id: 'homepage.userTitle', message: '谁在使用 Spring Cloud Alibaba' }),
};
