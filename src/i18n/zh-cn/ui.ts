...
export default {
	...
	'home.website.ai.title': '为什么选择 Spring AI 阿里巴巴',
	'home.website.ai.1.title': '专属 Spring 开发者的 AI 框架',
	'home.website.ai.1.description': 'Spring AI 与阿里云官方合作共建，原生支持 Spring Boot 体系，让你的 Bean 具备生成式 AI 能力。',
	'home.website.ai.2.title': 'Model, Prompt, RAG, Tools',
	'home.website.ai.2.description': '兼具提示词模板（prompt templating）、聊天记忆（chat memory）、格式化输出（output parsing）等低层次抽象与 RAG、智能体（agent）等高层次抽象。',
	'home.website.ai.3.title': '阿里云大模型与云原生最佳实践',
	'home.website.ai.3.description': '阿里云通义系列 AI 模型驱动，深度集成网关、模版管理、serverless、可观测等云原生应用基础设施。',
